...
$(document).ready(function () {
    ...
    initHeaderFooter = function () {
        ...
        $('.close-project').on('click', function (e) {
            ...
            if ($('body').hasClass('single-project')) {
                ...
                TweenLite.to(window, 0.7, {
                    scrollTo: {y: 0, autoKill: false}, ease: Power3.easeInOut, onComplete: function () {
                            ...
                            success: function (data) {
                                ...
                                $('.page-container').append(dataListProjects).delay(30).queue(function () {
                                    TweenLite.set(window, {
                                        scrollTo: {y: currentScrollTop}, autoKill: false, onComplete: function () {
        ...
        function onScroll() {
            ...
            if (scrollTop > $('.page-container').outerHeight() - window.innerHeight + borderWidth - 60) {
                ...
                if (wW > 768) {
                    TweenLite.set($('footer .briefLink'), {
                        y: -footerHeight * 1 + ((scrollTop - ($('.page-container').outerHeight() - window.innerHeight)) * 1),
                        ease: Linear.easeNone
                    });
                    TweenLite.set($('footer .newsletterLink'), {
                        y: -footerHeight * 1 + ((scrollTop - ($('.page-container').outerHeight() - window.innerHeight)) * 1),
                        ease: Linear.easeNone
                    });
                    TweenLite.set($('footer .contact'), {
                        y: -footerHeight * 0.5 + ((scrollTop - ($('.page-container').outerHeight() - window.innerHeight)) * 0.5),
                        ease: Linear.easeNone
                    });
                    TweenLite.set($('footer .credits'), {
                        y: -footerHeight * 0.1 + ((scrollTop - ($('.page-container').outerHeight() - window.innerHeight)) * 0.1),
                        ease: Linear.easeNone
                    });
                }
                TweenLite.set($('.scrolltop'), {
                    y: -(scrollTop - ($('.page-container').outerHeight() - window.innerHeight + borderWidth - 60)),
                    ease: Linear.easeNone
                });
                TweenLite.set($('.scrolldown'), {
                    y: -(scrollTop - ($('.page-container').outerHeight() - window.innerHeight + borderWidth - 60)),
                    ease: Linear.easeNone
                });
    ...
    initHome = function () {
        ...
        tlHello.staggerFrom($("#hello_dot > *"), 0.6, {
            scale: 0,
        ...
        tlPreambule.staggerFrom($(preambuleLines).find('span'), 1.2, {
            y: "100%",
            ease: Power3.easeInOut
        }, 0.05, "-=1.6");

        var prllxVideoContainer = TweenLite.to(".video-container img", 1, {
            yPercent: 50,
            ease: Linear.easeNone,
            paused: true
        });
        ...
        tlCreativity.staggerFrom($(creaIntroLines).find('> span'), 1.2, {
            y: "100%",
            ease: Power3.easeInOut
        }, 0.08, "-=1");
        tlCreativity.from(".creativity .block-content p.intro + p", 0.8, {
            y: 60,
            opacity: 0,
            ease: Power3.easeOut
        }, "-=1")
        ...
        tlHomeIdeas.staggerFrom($(ideasIntroLines).find('> span'), 1.2, {
            y: "100%",
            ease: Power3.easeInOut
        }, 0.08, "-=1");
        ...
        function onScroll() {
            ...
            if (scrollAmount > $('.preambule').outerHeight() && scrollAmount < $('.preambule').outerHeight() + wH) {
                ...
                TweenLite.to($('.hello'), 0, {
                    y: -(scrollAmount - $('.preambule').outerHeight()) * 0.6,
                    ease: Linear.easeNone
                });
                TweenLite.to($('.preambule'), 0, {
                    y: -(scrollAmount - $('.preambule').outerHeight()) * 0.4,
                    ease: Linear.easeNone
                });
            } else {
    ...
    initProjects = function () {
        ...
        tlProjects.staggerFrom($('section.intro h1 .msk').find('span'), 0.8, {
            y: "100%",
            ease: Power3.easeInOut
        }, 0.08, "-=1");
        tlProjects.staggerFrom($(projetcsIntroLines).find('span'), 1.2, {
            y: "100%",
            ease: Power3.easeInOut
        }, 0.1, "-=1");
    ...
    initProject = function () {
        ...
        tlProject.staggerFrom($(projetcIntroTitleLines).find('span'), 1.2, {
            y: "100%",
            ease: Power3.easeInOut
        }, 0.1, 0.1);
        tlProject.staggerFrom($(projetcIntroLines).find('span'), 1.2, {y: "100%", ease: Power3.easeInOut}, 0.1, 0.2);
        tlProject.from($('.project-intro .project-link'), 1.2, {y: "100%", opacity: 0, ease: Power3.easeInOut}, 0.4);
        tlProject.staggerFrom($('.project-intro .row > * > *'), 1.2, {
            y: 20,
            opacity: 0,
            ease: Power3.easeInOut
        }, 0.05, 0.8);
    ...
    initIdeas = function () {
        ...
        tlContact.staggerFrom($(contactIntroTxtLines).find('span'), 1.2, {
            y: "100%",
            ease: Power3.easeInOut
        }, 0.1, "-=1");
        tlContact.staggerFrom(".contact-ideas p:not(.intro)", 1.2, {
            y: 150,
            opacity: 0,
            ease: Power3.easeOut
        }, 0.1, "-=1");
    ...
    initRecrutement = function () {
        ...
        console.log('Creers Page initialised salut');
    ...
    initPhilo = function () {
        ...
        tlPhilo.staggerFrom($('section.intro h1 .msk').find('span'), 0.8, {
            y: "100%",
            ease: Power3.easeInOut
        }, 0.08, "-=1");
        ...
        var animationIntroTxt = TweenLite.to('.intro .page-content', 1, {
            xPercent: 25,
            ease: Linear.easeNone,
            paused: true
        });
    ...
    initRSE = function () {
        ...
        // Intro
        tlRSE = new TimelineLite({paused: true});
        tlRSE.from(".intro h1 svg > *", 1.2, {drawSVG: "0%", ease: Power3.easeOut}, 0.5);
        tlRSE.staggerFrom($('.intro h1 .msk').find('span'), 1.6, {y: "100%", ease: Power3.easeOut}, 0.08, "-=1");
        tlRSE.from(".intro .page-visuel", 2.4, {y: "100%", ease: Power3.easeOut}, "-=2");


        //Content
        tlRSEContent = new TimelineLite({paused: true});
        var contentIntroTxt = new SplitText(".page-content p.intro", {type: "lines"});
        var contentIntroTxtLines = contentIntroTxt.lines;
        for (var i = 0; i < contentIntroTxtLines.length; i++) {
            contentIntroTxtLines[i].innerHTML = '<span>' + contentIntroTxtLines[i].innerHTML + '</span>';
        }
        tlRSEContent.staggerFrom($(contentIntroTxtLines).find('span'), 1.2, {y: "100%", ease: Power3.easeInOut}, 0.1);
        tlRSEContent.staggerFrom($('.page-content .text p'), 1.2, {
            opacity: 0,
            y: "100%",
            ease: Power3.easeInOut
        }, 0.01, '-=1');
        ...
        const randomizeProfile = (profil) => {
            TweenLite.set(profil[0], {x: () => getRandomArbitrary(-1 * profil.width(), $('.Team__portraits').width())})
        }

        const portraitTLs = []
        $('.Team__portraits > div').each(function () {
            randomizeProfile($(this))

            const profilTL = TweenMax.fromTo(
                $(this), getRandomArbitrary(24, 32),
                {
                    y: $('.Team__portraits').height() + $(this).width()
                },
                {
                    y: () => -($(this).width() + $('.Team__portraits').height() * 0.5),
                    repeat: -1,
                    ease: 'Linear.easeNone',
                    overwrite: true,
                    onRepeat: () => randomizeProfile($(this))
                }
            )

            profilTL.progress(getRandomArbitrary(0, 1))
            profilTL.pause()
            portraitTLs.push(profilTL)

        });

        $('.Team__portraits').viewportChecker({
            repeat: true,
            callbackFunction: function (elem, action) {
                if (elem.is('.Team__portraits')) {

                    if (elem.hasClass('visible') && action === "add" && !elem.hasClass('animating')) {
                        elem.addClass('animating');
                        console.log('play')
                        portraitTLs.forEach(tl => tl.resume())
                    ...
                    if (!elem.hasClass('visible') && action === "remove" && elem.hasClass('animating')) {
                        elem.removeClass('animating');
                        console.log('pause')
                        portraitTLs.forEach(tl => tl.pause())
                    }
                }
            }
        });
        ...
        // Collapses
        $('.Axes__item .headline').on('click', function (e) {
            e.preventDefault()
            if ($(this).parent().attr("data-collapse") !== undefined) {
                console.log('remove')
                $(this).parent().removeAttr("data-collapse")
            } else {
                console.log('set')
                $(this).parent().attr("data-collapse", "")
            }
        })

        // Prlllx
        TweenLite.set(".page-visuel img", {y: '-25%'});
        var prllxIdeasVisuel = TweenLite.to(".page-visuel img", 1, {yPercent: 25, ease: Linear.easeNone, paused: true});
        TweenLite.ticker.addEventListener("tick", onScroll);

        function onScroll() {
            if (!$('body').hasClass('page-rse')) return;
            //PRLLX IDEAS VISUEL
            var min = $(".page-visuel").offset().top - wH;
            var max = $(".page-visuel").offset().top + $(".page-visuel").outerHeight();
            var norm = clamp(normalize(window.pageYOffset, min, max), 0, 1);
            prllxIdeasVisuel.progress(norm);
        }

        $('.intro').delay(320).queue(function () {
            tlRSE.play().timeScale(2);

            $('.animated').viewportChecker({
                repeat: false,
                offset: "25%",
                callbackFunction: function (elem, action) {
                    if (elem.is('.page-content')) {
                        if (elem.hasClass('visible') && action == "add" && !elem.hasClass('animating')) {
                            elem.addClass('animating');
                            tlRSEContent.play().timeScale(1);
                        }

                        if (!elem.hasClass('visible') && action == "remove" && elem.hasClass('animating')) {
                            elem.removeClass('animating');
                            tlRSEContent.pause(0);
                        }
                    }
                }
            });
        ...
        $('body').removeClass('loaded loadProject showProject hideNav').addClass('loading').delay(transitionPageDelay).queue(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    var targetPageHref = pageData.data('switch-lang');

                    let target_wpml_permalink_en = pageData.data('wpml-permalink-en');
                    let target_wpml_permalink_fr = pageData.data('wpml-permalink-fr');
                    ...
                    if (prev) {
                        TweenLite.to(prev, 0.6, {
                            y: -10, opacity: 0, ease: Power3.easeInOut, onComplete: function () {
                                prev.remove();
                            }
                        });
                    }
                    ...
                    let wpml_permalink_en = document.getElementById('wpml_permalink_en');
                    let wpml_permalink_fr = document.getElementById('wpml_permalink_fr');

                    wpml_permalink_en.setAttribute('href', target_wpml_permalink_en);
                    wpml_permalink_fr.setAttribute('href', target_wpml_permalink_fr);
    ...
    function checkNavigateur() {
        ...
        if (Sniff.browser.name) document.querySelector('html').classList.add(Sniff.browser.name);
